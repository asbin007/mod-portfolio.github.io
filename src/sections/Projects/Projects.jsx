...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Built a responsive e-commerce apparel storefront with dynamic, filterable product listings, admin panel, Google OAuth, real-time WebSocket features, and a streamlined cart-to-checkout flow.",
      image: "👕",
      category: "fullstack",
      technologies: ["React 19", "TypeScript", "Next.js 15", "Tailwind CSS", "Express.js", "PostgreSQL", "Sequelize", "MongoDB", "Cloudinary", "JWT", "WebSockets", "Google OAuth"],
      github: "https://github.com/asbin007/E-com-sports",
      live: "https://www.aurascreen.me",
      features: [
        "React SPA with Vite + TypeScript & Framer Motion animations",
        "Next.js 15 Admin Panel with dark/light mode",
        "Express backend with PostgreSQL, Sequelize ORM & Cloudinary uploads",
        "Google OAuth, JWT auth & bcrypt password hashing",
        "Real-time WebSocket integration",
        "Input validation, testing with Jest & Supertest"
      ],
    ...
    },
    {
      ...
      image: "☕",
      category: "fullstack",
      technologies: ["React", "TypeScript", "Express.js", "Supabase"],
      github: "https://github.com/asbin007",
      live: "https://chiyaguff.asbingamer.workers.dev",
      features: [
